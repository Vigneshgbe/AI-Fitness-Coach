  ...
  return (
    ...
    >
      ...
      <Select onValueChange={(v) => handleChange("gender", v)} required>
        <SelectTrigger className="d-flex justify-center"><SelectValue placeholder="Specify Your Gender" /></SelectTrigger>
        <SelectContent>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <Input placeholder="Your Height (cm)" type="number" onChange={(e) => handleChange("height", e.target.value)} required />
        <Input placeholder="Your Weight (kg)" type="number" onChange={(e) => handleChange("weight", e.target.value)} required />
      </div>
